      ...
      <div className="pricingContainer">
        ...
        <div className="pricing-cards-container">
          <div className="pricing-card">
            ...
            <h2>1 Session</h2>
              <h3>
                <span style={{fontSize: '1.5rem'}}>for just </span><s> ₹1500</s> ₹1299
              </h3>
            </div>
          </div>
          <div className="pricing-card">
            ...
            <h2>5 Sessions</h2>
              <h3>
              <span style={{fontSize: '1.5rem'}}>for just </span><s> ₹7500</s> ₹4999
              </h3>
            </div>
          </div>
          <div className="pricing-card">
            ...
            <h2>8 Sessions</h2>
              <h3>
              <span style={{fontSize: '1.5rem'}}>for just </span><s> ₹12000</s> ₹6999
              </h3>
            </div>
          </div>
        </div>
